...
@objcMembers public class TestObjectEleven : NSObject  {
	...
	required public  init(non_optionalFloat  _non_optionalFloat : Float,
	...
	convenience public init?(_ dictionary: Dictionary<String, AnyObject>)  {
												   ...
												   defaultsEnabled : true)
		{
			...
			self.init(non_optionalFloat : temp_non_optionalFloat,
...
extension TestObjectEleven {

	public override var debugDescription: String {

		var debug_string = "[TestObjectEleven]"

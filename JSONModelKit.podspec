Pod::Spec.new do |s|
  ...
  s.source_files = "Source/*.*", "Source/ModelScript/*.*", "Source/JSONModelKit/*.*", "Source/JSONModelKit/Parsers/*.*", "Source/JSONModelKit/Transformer/*.*", "Source/JSONModelKit/Validator/*.*"
end

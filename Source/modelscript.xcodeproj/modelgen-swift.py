...
def generate_model(plistPaths, output_directory, version, testEnabled, jsonFormatEnabled, autoImport):
	...
	projectName = ''
	all_txt_files = filter(lambda x: x.endswith('.xcodeproj'), os.listdir(output_directory))
	...
	save_files_to_project(output_directory, internal_file_names, external_file_names)

...
final class ComplexValueArrayParser {
    ...
    class func arrayRepresentation(_ collectionSubType : String?, data : Dictionary<String, Dictionary<String, AnyObject>>, instantiator : JMInstantiatorProtocol) -> [AnyObject] {
